...
class LiveBackendBrowserLoadMixin:
    """Load an instrument/effect/clip browser item into a track: target
    track/clip-slot resolution, MIDI clip (.alc) import (including parsing
    the .alc XML directly when Live doesn't create a deterministic source
    track), and note/length/groove import into the destination clip.
    """
