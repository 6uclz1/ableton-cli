...
REMOTE_ERROR_TO_EXIT_CODE: dict[str, ExitCode] = {
    ...
    "PROTOCOL_INVALID_RESPONSE": ExitCode.PROTOCOL_MISMATCH,
    "PROTOCOL_REQUEST_ID_MISMATCH": ExitCode.PROTOCOL_MISMATCH,
    "TIMEOUT": ExitCode.TIMEOUT,
    "BATCH_STEP_FAILED": ExitCode.EXECUTION_FAILED,
    "REMOTE_BUSY": ExitCode.EXECUTION_FAILED,
    "READ_ONLY_VIOLATION": ExitCode.EXECUTION_FAILED,
    "BATCH_PREFLIGHT_FAILED": ExitCode.EXECUTION_FAILED,
    "BATCH_ASSERT_FAILED": ExitCode.EXECUTION_FAILED,
    "BATCH_RETRY_EXHAUSTED": ExitCode.EXECUTION_FAILED,
