...
| `audio_loudness_analyze` | `uv run ableton-cli --output json audio loudness analyze --path <wav>` | Analyze an offline render for LUFS, peak, RMS, crest, clipping, and DC offset. |
